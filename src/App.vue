<template>
  <div id="app">
    ...
    <button v-if="user.isAuthenticated" v-on:click="onLogoutClicked">
      Logout
    </button>
    <button v-if="!user.isAuthenticated" v-on:click="onLoginClicked">
      Login
    </button>
    ...
    <div id="nav">
      ...
      <router-link
        v-if="isAuthorizedUser('modificar')"
        :to="{ name: 'Modificar' }"
      ...
      |
      <router-link
        v-if="isAuthorizedUser('eliminar')"
        :to="{ name: 'Eliminar' }"
        >Eliminar</router-link
      >
      <router-link v-if="user.isAuthenticated" to="/about">About</router-link>
    </div>
